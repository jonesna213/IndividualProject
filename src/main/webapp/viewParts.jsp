    ...
    <body>
        <div class="container">
            ...
            <form class="row my-3" action="searchParts" method="get">
                ...
                <div class="col-auto">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="searchBy" value="partName" id="byPartName" checked>
                        <label class="form-check-label" for="byPartName">By Part Name</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="searchBy" value="partNumber" id="byPartNumber" >
            ...
            <c:if test="${parts == null}" >
                ...
                <c:if test="${searchedFor != null}" >
                    <p>There are no results for your search of "${searchedFor}".</p>
            ...
            <c:if test="${parts != null}" >
                <c:if test="${searchedFor != null}" >
                    <p>Results for the search of "${searchedFor}".</p>
                </c:if>
